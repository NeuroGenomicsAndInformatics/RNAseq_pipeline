...
#TODO add logging for all of these functions Starting and end 
    def getreadscount(self, mpileup, countmapped=False):
        logging.info('Starting getreadscount')
        ...
        logging.info('Ending getreadscount')
        return count


    def genecount(self, circ_coordinates, bamfile, ref, tid):
        logging.info('Starting genecount')
        """
        ...
        logging.info('Ending genecount')
        return startcount, endcount


    def submpileup(self, mpileup1, mpileup2, left=True):
        logging.info('Starting submpileup')
        ...
        logging.info('Ending submpileup')
        return new_mpileup

    def linearsplicedreadscount(self, circ_coor, bamfile, ref, header=True):
        logging.info('Starting linearsplicedreadscount')
    ...
    def comb_gen_count(self, circ_coor, bamfile, ref, output, countlinearsplicedreads=True):
        ...
        logging.info('Ending comb_gen_count')
